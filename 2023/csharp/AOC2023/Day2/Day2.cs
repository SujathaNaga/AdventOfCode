...
namespace AOC2023
{
    class Day2
    {
        public string sampleInput = @"Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green";

        public string input = @"Game 1: 4 red, 1 green, 15 blue; 6 green, 2 red, 10 blue; 7 blue, 6 green, 4 red; 12 blue, 10 green, 3 red
...
Game 100: 11 red, 1 blue, 2 green; 3 red, 3 green; 1 blue, 8 red, 4 green; 5 green, 5 blue, 1 red; 2 green, 1 red, 6 blue; 2 green, 8 red, 1 blue";
        ...
        {
            Game g = new Game();
            g.id = ParseInt(line, @"Game (\d+)").First();
            g.red = ParseInt(line, @"(\d+) red").Max();
            g.green = ParseInt(line, @"(\d+) green").Max();
            g.blue = ParseInt(line, @"(\d+) blue").Max();
            return g;
        }
       
        private IEnumerable<int> ParseInt(string line, string pattern)
        {
