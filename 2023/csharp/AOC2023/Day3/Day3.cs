...
...$.*....
.664.598..";
        public string input = @".854...........................................................................362...........271...732........838.........24................
...*.............................117*...........459........767*648....#.........*...................................$...&..=................
...
.......................125.......311............715........263...........................................173...................235....291...";
        ...
        private void SolveA()
        {
            ...
            var symbols = Parse(rows, new Regex(@"[^.0-9]")); // not ., not digit                
            var nums = Parse(rows, new Regex(@"\d+"));
            
            var matches = from n in nums
                            where symbols.Any(s => FindCloser(s, n))
                            select n.intValue;

            Debug.WriteLine($"A) {matches.Sum()}");
        }
        ...
        private void SolveB()
        {
            ...
            var matches = from g in gears
                          let neighbours = from n in numbers where FindCloser(n, g) select n.intValue
                          where neighbours.Count() == 2
                          select neighbours.First() * neighbours.Last();
            Debug.WriteLine($"B) {matches.Sum()}");
        }

        bool FindCloser(CustomStruct symbol, CustomStruct num) =>
         Math.Abs(num.row - symbol.row) <= 1 && // within a 1 row radius
         symbol.col <= num.col + num.text.Length && // symbol to the left of col
        ...
        private IEnumerable<CustomStruct> Parse(string[] rows, Regex rx)
        {
            ...
            {
                foreach(Match m in rx.Matches(rows[row]))
                {
                    yield return new CustomStruct { text = m.Value, row = row, col = m.Index };
                }
            }
        }
